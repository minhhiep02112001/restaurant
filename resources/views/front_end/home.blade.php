    ...
    <article style="height: auto" class="container-fluid">
        ...
        <section class="white-section">
            ...
            <div class="row">
                ...
                <div class="col-sm-3"><img alt="{{ $config_website->website }}"
                            src="{{ asset('images/press.png') }}" class="img-responsive img-thumbnail" /> </div>
                <div class="col-sm-3"> <img alt="{{ $config_website->website }}"
                            src="{{ asset('images/press_1.png') }}" class="img-responsive img-thumbnail" /></div>
            </div>
        </section>
