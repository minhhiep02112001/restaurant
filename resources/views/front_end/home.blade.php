...
@section('content')
    <main class="Index" data-collection-id="5c4a47c71ae6cf770c90fd6e"
        ...
        <section id="modern-organic-thai" class="Index-page Index-page--has-image" data-parallax-original-element
            data-collection-id="5c4768b1cd83663a096f569f" data-parallax-id="5c4768b1cd83663a096f569f"
            ...
            <div class="Index-page-content  sqs-alternate-block-style-container">
                <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1550694809322"
                    id="page-5c4768b1cd83663a096f569f">
        ...
        <section id="about-02" class="Index-page" data-collection-id="5c4b8a5e42bfc120277d72fc"
            ...
            <div class="Index-page-content ">
                <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1588614612834"
                    id="page-5c4b8a5e42bfc120277d72fc">
                    <div class="row sqs-row">
                        <div class="col sqs-col-12 span-12">
                            <div class="sqs-block gallery-block sqs-block-gallery"
                                ...
                                <div class="sqs-block-content">
                                    <div
                                        class="sqs-gallery-container sqs-gallery-block-grid sqs-gallery-aspect-ratio-standard-vertical sqs-gallery-thumbnails-per-row-4 sqs-gallery-block-show-meta block-animation-none clear">
        ...
        <section id="eat-together" class="Index-page Index-page--has-image" data-parallax-original-element
            ...
            <div class="Index-page-content  sqs-alternate-block-style-container">
                <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1550692609997"
