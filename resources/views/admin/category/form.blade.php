                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-input m-input--square" name="show_content">
                                            ...
                                            <option value="1" {{ !empty($row['show_content']) ? 'selected' : '' }}>Hiển
                                                thị</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-input m-input--square" name="is_status">
                                            <option value="0">Không hiển thị</option>
                                            <option value="1" {{ !empty($row['is_status']) ? 'selected' : '' }}>Hiển
                                                thị
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-input m-input--square" name="is_robot">
                                            ...
                                            <option value="1" {{ !empty($row['is_robot']) ? 'selected' : '' }}>Index
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-input m-input--square" name="is_text_speech">
                                            ...
                                            <option value="1" {{ !empty($row['is_text_speech']) ? 'selected' : '' }}>Có
                                            </option>
                                        </select>
                                    </div>
                                </div>
