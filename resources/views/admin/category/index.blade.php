                    ...
                    <div class="table-data__tool mb-0">
                        ...
                        <div class="table-data__tool-right">
                            <button class="au-btn au-btn-icon au-btn--green au-btn--small btn-call-modal" id="btnAddData"
                                data-url-form="{{ route('admin.category.create') }}">
                            ...
                            <div class="row" id="search_data_table">
                                ...
                                <div class="form-group col-2">
                                    <select name="is_robot" class="form-control" aria-placeholder="Trạng thái">
                                        ...
                                        <option value="2">New Crawler</option>
                                    </select>
                                </div>
                            </div>
                        </form>
...
@push('scripts')
    ...
    <script>
        //setting url
        var url_ajax_list = window.APP_URL + "/admin/ajax/category";
            ...
            datatables_columns = [{
                ...
                },
                {
                    ...
                    render: function(t, item, data) {
                        return '<p class="text-center em-category" data-id="' + data.parent_id + '" > ' +
                            data.parent_id + '</p>';
                    }
                },
                {
